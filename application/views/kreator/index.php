...
<head>
  ...
  <!-- Ion Slider -->
  <link href="<?php echo base_url('assets/backend/plugins/ionslider/ion.rangeSlider.css'); ?>" rel="stylesheet" type="text/css" />
  <!-- ion slider Nice -->
  <link href="<?php echo base_url('assets/backend/plugins/ionslider/ion.rangeSlider.skinNice.css'); ?>" rel="stylesheet" type="text/css" />
  <!-- bootstrap slider -->
  <link href="<?php echo base_url('assets/backend/plugins/bootstrap-slider/slider.css'); ?>" rel="stylesheet" type="text/css" />
