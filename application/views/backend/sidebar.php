  ...
  <section class="sidebar">
    ...
    <div class="user-panel">
      <div class="pull-left info">
        <p><?php echo $this->session->userdata('admin_nama'); ?></b></p>
    ...
    <ul class="sidebar-menu">
      ...
      <li class="<?php if ($this->uri->segment(2)=='customer') echo 'active'; ?> treeview">
        ...
        <ul class="treeview-menu">
          <li class="<?php if ($this->uri->segment(2)=='customer' AND $this->uri->segment(3)=='view') echo 'active'; ?>"><a href="<?php echo base_url('dashboard/customer/view'); ?>"><i class="fa fa-server"></i> Lihat Customer</a></li>
        </ul>
      </li>
      ...
      <li class="<?php if ($this->uri->segment(2)=='admin') echo 'active'; ?> treeview">
        ...
        <ul class="treeview-menu">
          ...
          <li class="<?php if ($this->uri->segment(2)=='admin' AND $this->uri->segment(3)=='add') echo 'active'; ?>"><a href="<?php echo base_url('dashboard/admin/add'); ?>"><i class="fa fa-user-plus"></i> Tambah Admin</a></li>
          <li class="<?php if ($this->uri->segment(2)=='admin' AND $this->uri->segment(3)=='profil') echo 'active'; ?>"><a href="<?php echo base_url('dashboard/admin/profil'); ?>"><i class="fa fa-user"></i> Profil</a></li>
        </ul>
      </li>
    </ul>
  </section>
